...
class GradInversionInverter():
    ...
    def run_inversion(
        ...
        GAN_model_tmp = load_pretrained_GAN(args.GAN_path)
        ...
        print(GAN_model.load_state_dict(GAN_model_tmp.state_dict()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', default='../output_attack/client8_prec0', type=str)    
    ...
    parser.add_argument('--z_iter', type=int, default=5000)
    parser.add_argument('--z_lr', type=float, default=1e-2)       
    ...
    parser.add_argument('--grad_l2', type=float, default=1)
    parser.add_argument('--grad_cos', type=float, default=1)
    parser.add_argument('--original_bn_l2', type=float, default=5e-2)
    ...
    if args.config == 'chestXray_config':
        args.norm_mean = (0.5329, 0.5329, 0.5329)
        args.norm_std = (0.2534, 0.2534, 0.2534)
        args.GAN_path = '/data2/jl2/FL-RL/code_fl_rl/net/GAN/pretrained_model/network-snapshot-003350_xray.pkl'
        args.template_path ='../data/ChestX-ray14/mean_img.png'
    elif args.config == 'eye_config':
        args.norm_mean = (0.1168, 0.1869, 0.2992)
        args.norm_std = (0.1493, 0.1901, 0.2815)
        args.GAN_path = '/data2/jl2/FL-RL/code_fl_rl/net/GAN/pretrained_model/network-snapshot-003100_eye.pkl'
